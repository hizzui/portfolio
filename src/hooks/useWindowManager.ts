...
export const useWindowManager = () => {
  ...
  const openWindow = useCallback(
    (type: WindowType, title: string, extraData?: Record<string, unknown>) => {
      ...
      const baseSizes: Record<WindowType, { width: number; height: number }> = {
        about: { width: 550, height: 650 },
        work: { width: 500, height: 400 },
        stack: { width: 500, height: 400 },
      ...
      const newWindow: WindowState = {
        ...
        isMaximized: false,
        data: extraData,
        headerColor: extraData?.headerColor as string | undefined,
      };
