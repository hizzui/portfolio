...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="flex justify-between items-center px-3 sm:px-8 md:px-12 py-2 sm:py-4 border-b-4 border-black z-50 relative gap-3 sm:gap-4" style={{
      ...
      <nav className="flex gap-1 sm:gap-3 items-center flex-wrap justify-center flex-1">
